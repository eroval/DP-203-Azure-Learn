...
account_name = "h24pgen2"
container_name = "data"
relative_path = "raw"
adls_path = 'abfss://%s@%s.dfs.core.windows.net/%s' % (container_name, account_name, relative_path)

spark.conf.set("fs.azure.account.auth.type.%s.dfs.core.windows.net" %account_name, "SharedKey")
spark.conf.set("fs.azure.account.key.%s.dfs.core.windows.net" %account_name ,"bJRdiiB+rwuSaJn+Fy4XYdBMyHpRXe9JMHqG4AH8xxGuSrifF8IJlM65hUrPBHtU/dtuGJIg3GpIpij9Ccu6vA==")
...
newdf = newdf.filter(col("Operationname").isNotNull());
display(newdf)