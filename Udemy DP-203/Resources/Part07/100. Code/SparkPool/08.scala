...
val df = spark.read.format("json").load("abfss://data@dh24pgen2.dfs.core.windows.net/raw/customer/customer_arr.json")
display(df)
...
%%spark
import org.apache.spark.sql.functions._
val df = spark.read.format("json").load("abfss://data@dh24pgen2.dfs.core.windows.net/raw/customer/customer_obj.json")
