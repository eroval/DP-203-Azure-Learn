...
val connectionString = "Endpoint=sb://myeventhubbro.servicebus.windows.net/;SharedAccessKeyName=databricks;SharedAccessKey=/VaJhHt07WMLZhmZrsFHljo1qtRRjfLg8fq7UGmYjUE=;EntityPath=dbhub"
...
val connection = "jdbc:sqlserver://synapsebro.sql.azuresynapse.net:1433;database=mydedicatedpool;user=sqladminuser;password=$dfhdhf8;encrypt=true;trustServerCertificate=false;"
